...
\begin{frame}{Datasets}
    \begin{table}[h]
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|c|}
            ...
            \hline
            MI BCI EEG Giga Science Databas (DBIII MI)~\footnotemark[3] & 50 & 200 & Motor imagery & 2 & 64 & $500$Hz \\
            \hline
        \end{tabular}
        }
    \end{table}
...
\begin{frame}[allowframebreaks]{Impact of Prior CSP Filtering}
...
\begin{frame}{Subject Dependent and Group Analysis Results I}
    \centering
    \resizebox{0.7\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/acc_eeg_gfc_net.tikz}}
\end{frame}

\begin{frame}{Subject Dependent and Group Analysis Results II}
    \centering
    \resizebox{0.7\linewidth}{!}{\input{figures/semaforo.tex}}
\end{frame}
...
\begin{frame}{Subject Dependent and Group Analysis Results IV}
        \centering
        \resizebox{0.7\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/groped_std.tikz}}
\end{frame}


\begin{frame}{Functional connectivity analysis I}
    \centering
    \resizebox{0.7\linewidth}{!}{\input{figures/pvalue-matrix_2.tex}}
\end{frame}

\begin{frame}{Functional connectivity analysis II}
    \centering
    \resizebox{0.7\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/renyi_boxplot.tikz}}
\end{frame}
...
\begin{frame}{Functional connectivity analysis III}
    \begin{figure}
       ...
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/circonnecitvity_good_2}}
       \end{subfigure}
       ~
       \begin{subfigure}[b]{.3\linewidth}
           \centering 	\resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/circonnecitvity_medium_2}}	
       \end{subfigure}
       ~
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/circonnecitvity_bad_2}}	
       \end{subfigure}
       \\
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_good_2}}	
       \end{subfigure}
       ~ 
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_medium_2}}	
       \end{subfigure}
       ~ 
       \begin{subfigure}[b]{0.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_bad_2}}	
       \end{subfigure}
       \\
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_weights_model_good_2}}	
       \end{subfigure}
       ~ 
       \begin{subfigure}[b]{.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_weights_model_medium_2}}
       \end{subfigure}
       ~ 
       \begin{subfigure}[b]{0.3\linewidth}
           \centering
           \resizebox{1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/topoplot_weights_model_bad_2}}
       \end{subfigure}
       \\
       \begin{subfigure}[b]{\linewidth}
           \centering
           \includegraphics[width=\linewidth]{../Tesis_document/Figures/Objective_2/colorbar.pdf}
       \end{subfigure}
   \end{figure}
\end{frame}
