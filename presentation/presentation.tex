...
\begin{frame}{BCI Competition IV Dataset IIa - DBI MI}
    ...
    \begin{figure}[!ht]
        \centering
        \resizebox{0.3\linewidth}{!}{\input{../Tesis_document/Figures/preliminaries/procedure_BCI2a.tikz}}
    \end{figure}
      \begin{columns}
        \column{0.5\textwidth}
            \centering
...
\begin{frame}{Gamma Motor Execution Database—DBII ME}
    \begin{figure}[h!]
        \centering
            \resizebox{0.9\linewidth}{!}{\input{../Tesis_document/Figures/preliminaries/procedure_gamma.tikz}}
    \end{figure}
