...
\begin{frame}{Classifier Accuracy of Individuals}
    ...
    \begin{itemize}
        ...
        \item KCS-FC (ours) ensures several subjects exceed the BCI-inefficiency threshold (below 70\%).
    \end{itemize}
\end{frame}
    ...
    \begin{columns}
        ...
        Average accuracy drop across feature removal percentage
                \begin{table}[h!]
                    ...
                    \multirow{3}{*}{\textbf{IRKCS-FCnet}} & \textbf{G I} &  44.80 & 39.21 &  37.79 &  30.55 & \cellcolor{GI!80} 22.46 \\
