...
\begin{frame}{Subject Dependent and Group Analysis Results I}
    \begin{columns}
        \column{0.7\textwidth}
            \centering
            \resizebox{1.1\linewidth}{!}{\input{../Tesis_document/Figures/Objective_2/acc_eeg_gfc_net.tikz}}
        \column{0.3\textwidth}
        \begin{itemize}
...
\begin{frame}{Classifier Accuracy Comparison of DL Approaches I}
    ...
    \begin{itemize}
        ...
        \item CS-FCNet (ours) achieves the highest scores with the lowest standard deviation.
    \end{itemize}
\end{frame}
    ...
    \begin{columns}
        \column{0.33\textwidth}
            \begin{itemize}
                ...
                \item KCS-FCNet outperforms ShallowConvNet while using 20 times fewer parameters.
            \end{itemize}
...
\centering
    \begin{itemize}
        ...
        \item For GII, $60\%$ of the most relevant channels are in the motor-related brain area.
        \item For GIII, only $30\%$ of the most relevant channels are in the motor-related area.
    \end{itemize}
\end{frame}
